...
class FirebirdConnectorTest extends TestCase
{
    ...
    {
        $this->connector = new FirebirdConnector();
    }
    ...
    public function test_get_schema_parses_firebird_metadata(): void
    {
        ...
        // Mock: first prepare returns tables, second prepare returns columns for CLIENTES, third returns columns for PRODUTOS (empty)
        $callCount = 0;
        $pdoMock = $this->createMock(\PDO::class);
